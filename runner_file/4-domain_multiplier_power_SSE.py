...
def main(
        ...
        Returns:
            None.
        """
        logger.info(f'NEW ! domain knowledge 5 segment tile experiment. Branch Multiplied scale factor test')
        ...
        params_abTEM = {#todo: find a better way to enter parameters
                ...
                "path_crystal": "/home/pb482/bott/gammaGa2O3_edited.cif",
        ...
        run_one_trial(problem_name=problem_name+'_SSE_dppow1_noNorm_gamma', 
                    problem=problem, 
                    algo=algo, 
                    trial=trial, 
                    n_init_evals=7, 
