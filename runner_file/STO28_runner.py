...
def main(
        ...
        """Run one replication for STO28 experiment   
        ...
        if isinstance(param_truth, str):
            ...
            ground_truth = (ground_truth / ground_truth.max()) #3/20/2026 changed to max to scale image to (0,1) then scale up to overall_scaling_factor
