...
def main(
        ...
        params_abTEM = {#todo: find a better way to enter parameters
                ...
                "path_crystal": "/home/fs01/dy327/bott-data/log/20260207_gao_beta/one_layer_beta_GaO.cif",
        ...
        problem = OptimizationProblem(ground_truth=ground_truth,
                                    ...
                                    save_results=True, 
                                    reduction_params={'reduction_type':'domain', 'reduction_kwargs':{'radius':0.37}},
        ...
        run_one_trial(problem_name=problem_name+'_radius_manual_guess', 
                    problem=problem, 
                    algo=algo, 
                    trial=trial, 
                    n_init_evals=7, 
                    ...
                    manual_init_evals = [[100,7,-5],[200,7,-5],[300,7,-5]],
                    )
